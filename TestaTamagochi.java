        ...
        while (true) {
            ...
            switch (escolha) {
                ...
                case 3: //Caso escolha 3 dorme
                    ...
                    System.out.println("\nDormiu");
                    break;
                case 4: //Caso escolha 4 dar remédio
                    if (tamagotchi.isDoente()) { // Verifica se o Tamagotchi está doente
                        tamagotchi.darRemedioOpcao4(); // Chama o método correspondente
                    } else {
                        System.out.println("Não é necessário dar remédio, " + nomeTamagotchi + " não está doente.");
                    }
                    break;
